...
def bake(filePath, template=None):
    ...
    converted entry will be baked into the HTML template provided for posts.
    This is done simply using python's builtin string.format method. The format
    method will be called with a dictionary containing the (HTML) content of the
    post at the 'content' key and all of the multimarkdown headers, camelCased.
